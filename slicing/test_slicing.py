...
another_text = """
Take a block of text provided and strip() off the whitespace at the ends.
Split the whole block up by newline (\n).
 if the fitst character is lowercase, split it into words and add the last word
