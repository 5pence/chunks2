...
def get_total_points(belts=ninja_belts):
    """Calculate the amount of points rewarded given the
       ...
       attribute access: belt.score / belt.ninjas (get familiar with namedtuple here,
       ove them and use them all over the place!)
